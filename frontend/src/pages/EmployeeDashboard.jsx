  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: "#ffffff" }}>
      ...
      <div style={{
        ...
        <span style={{ fontWeight: "bold", fontSize: "1.2rem" }}>Employee Dashboard</span>
        <button
      ...
      <div style={{ padding: "2rem" }}>
        <h1 style={{ color: "#013220", marginBottom: "0.5rem" }}>Welcome, {username}!</h1>
        ...
        <div style={{ display: "flex", gap: "1rem" }}>
          <button
            ...
            style={{ backgroundColor: "#013220", color: "#ffffff", border: "none", padding: "0.6rem 1.2rem", borderRadius: "5px", cursor: "pointer", fontWeight: "bold" }}
        ...
        <div style={{ marginTop: "3rem" }}>
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", backgroundColor: "#0a4d1b", boxShadow: "0 2px 6px rgba(0,0,0,0.1)" }}>
            <thead>
            ...
            <tbody>
              {recentTransactions.length === 0 ? (
                <tr>
                  <td colSpan="6" style={{ textAlign: "center", padding: "10px", color: "#ffffff" }}>No transactions found.</td>
                </tr>
              ) : (
          ...
          <div style={{ marginTop: "1rem", display: "flex", gap: "1rem" }}>
            <button
              ...
              style={{ backgroundColor: "#013220", color: "#ffffff", border: "none", padding: "0.6rem 1.2rem", borderRadius: "5px", cursor: "pointer" }}
              onMouseOver={(e) => (e.target.style.backgroundColor = "#228B22")}
              onMouseOut={(e) => (e.target.style.backgroundColor = "#013220")}
            >
